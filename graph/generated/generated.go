...
func (ec *executionContext) _Query_user(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*ent.User)
	fc.Result = res
	return ec.marshalOUser2ᚖgolangᚑentᚑgqlgenᚑexampleᚋentᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOUser2ᚖgolangᚑentᚑgqlgenᚑexampleᚋentᚐUser(ctx context.Context, sel ast.SelectionSet, v *ent.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
